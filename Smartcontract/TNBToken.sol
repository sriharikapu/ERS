 ...
 *
 * Opensource Creative Commons Licence
 *
 * Credits to Aaron Swartz for his contribution in open source software
 *
 */
 ...
 */
contract TNBToken is ERC20Interface, SafeMath, Owned {

    mapping (address => uint256) balances;
    mapping (address => mapping (address => uint256)) allowed;
    string public constant name = "TNB Token";
    string public constant symbol = "TNB";
    uint8 public constant decimals = 4;
    string public version = '0.1.56.98';
    string public constant author = "Srihari Kapu";
